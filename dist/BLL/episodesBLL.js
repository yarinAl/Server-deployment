...
const episodesDAL_1 = require("../DAL/episodesDAL");
const cache_1 = __importDefault(require("../cache/cache"));
const sanitizer_1 = require("../sanitizer");
const getEpisode = (episodeId) => __awaiter(void 0, void 0, void 0, function* () {
    const getEpisodeCache = cache_1.default.get(`getEpisode:${episodeId}`);
    if (getEpisodeCache) {
        return getEpisodeCache;
    }
    const episodeData = yield (0, episodesDAL_1.getEpisode)(episodeId);
    const res = convertApiEpisodeToEpisode(episodeData);
    cache_1.default.set(`getEpisode:${episodeId}`, res);
    return res;
});
...
//# sourceMappingURL=episodesBLL.js.map